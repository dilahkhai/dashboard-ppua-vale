                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Leave</td>
                      <td>
                        <input type="text" name="crew_date_leave" class="form-control" id="dateInput">
                      </td>
                      <td>
                        <select class="form-control" name="crew_leave" id="crew_leave">
                          <option value="">-- Select Employee --</option>
                          @foreach ($users[$area->id] as $user)
              ...
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col d-flex">
                    ...
                    <a href="{{ route('man-power.create') }}" class="btn btn-primary">Input Data</a>
                    @endif
                  </div>
                </div>
              </div>
