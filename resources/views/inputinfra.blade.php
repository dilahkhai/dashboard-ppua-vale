      ...
      <div class="row">
                    ...
                    <div class="text-left">
                      ...
                      @foreach ($user as $employee)
                        <div class="row">
                          ...
                          <div class="col-1">
                            <input type="number" name="wta[]" class="form-control" value="{{$employee->todaystatusperday->wta ?? ''}}">
                          </div>
                        </div>
                      @endforeach
        ...
        <div class="col-md-6">
            <div class="card card-secondary">
                ...
                <form action="{{url('/inputinfraMcu')}}" method="POST">
                    @csrf
                    <div class="card-body text-right">
                        <div class="text-left">
                        {{-- Header --}}
      ...
      <div class="col-12">
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <form action="{{url('updateinfraTask')}}" method="POST">
                    @csrf
                    {{-- Value --}}
        ...
        <div class="modal fade" id="TaskModal" tabindex="-1" role="dialog" aria-labelledby="TaskModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('inputinfraTask')}}" method="POST">
                        @csrf
