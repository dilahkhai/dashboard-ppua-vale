            ...
            <form role="form" action="{{ route('sub-training.update', $subTraining->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="name" id="name" class="form-control" value="{{ $subTraining->name }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="certif_date" placeholder="Certif Date" value="{{ $subTraining->certif_date->format('Y-m-d') }}">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Training Schedule</label>
                  <input type="date" class="form-control" name="training_schedule" placeholder="Certif Date" value="{{ $subTraining->training_schedule }}">
                </div>
